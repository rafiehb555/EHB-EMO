...
def analyze_project():
    ...
    try:
        ...
        ], capture_output=True, text=True, cwd=api_server.project_root)
        ...
        if result.returncode == 0:
            return jsonify({
                ...
                "data": {
                    ...
                    "issues_found": ["Missing HIPAA documentation", "Incomplete test coverage"],
                    "recommendations": [
    ...
    try:
        ...
        if result.returncode == 0:
            return jsonify({
                ...
                "data": {
                    "agents_created": ["backend-agent.py", "frontend-agent.py", "security-agent.py"],
                    "status": "ready"
                }
            })
        else:
    ...
    try:
        ...
        if result.returncode == 0:
            return jsonify({
                ...
                "data": {
                    "issues_fixed": ["Missing files", "Configuration problems", "Compliance gaps"],
                    "status": "resolved"
                }
            })
        else:
...
def get_suggestions():
    ...
    return jsonify({
        ...
        "data": {
            ...
            "resources_needed": ["Database", "Authentication service", "Documentation tools"]
        }
    })
