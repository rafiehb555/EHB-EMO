#!/usr/bin/env python3
"""
EHB Frontend Error Fixer - Simple Version
Fixes all frontend errors without Unicode issues
"""
...
class FrontendErrorFixer:
    ...
    def fix_configuration(self):
        ...
        with open(self.frontend_dir / "tsconfig.json", "w", encoding='utf-8') as f:
...
'''
        ...
        with open(self.frontend_dir / "next.config.js", "w", encoding='utf-8') as f:
            f.write(next_config)
...
'''
        ...
        with open(components_dir / "PatientCard.tsx", "w", encoding='utf-8') as f:
...
'''
        ...
        with open(self.frontend_dir / "app" / "globals.css", "w", encoding='utf-8') as f:
            f.write(globals_css)
    ...
    def create_healthcare_dashboard(self):
        ...
        # Create directory
        dashboard_dir = self.frontend_dir / "app" / "healthcare-dashboard"
...
'''
        ...
        with open(self.frontend_dir / "app" / "layout.tsx", "w", encoding='utf-8') as f:
            f.write(layout)
