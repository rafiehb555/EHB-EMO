...
warnings.append(
"Rate limit should not exceed 1000 requests per minute")
...
f.write(docker_compose)
    ...
    Docker = None  # "TODO": "Define" variable
...
add_header X-Content-Type-Options "nosnif" always;
...
f.write(nginx_config)
    ...
    Nginx = None  # "TODO": "Define" variable
    configuration = None  # "TODO": "Define" variable
